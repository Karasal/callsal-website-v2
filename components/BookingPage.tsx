    ...
    <div className={embedded ? "" : "space-y-16 lg:space-y-0 relative z-10 bg-black -mx-4 sm:-mx-6 lg:-mx-12 -mt-24 lg:-mt-28 px-4 sm:px-6 lg:px-12 pt-24 lg:pt-28 min-h-screen"}>
      ...
      <div className={embedded ? "max-w-5xl mx-auto" : "max-w-5xl mx-auto px-4 py-12 sm:py-16"}>
        ...
        <div className="glass-strong rounded-2xl overflow-hidden">
            {/* Step 1: Meeting Type */}
            {step === 1 && (
              <motion.div key="step1" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.15 }} className="p-5 sm:p-8 lg:p-12">
            ...
            {step === 2 && (
              <motion.div key="step2" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.15 }} className="p-5 sm:p-8 lg:p-12">
            ...
            {step === 3 && selectedDate && (
              <motion.div key="step3" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.15 }} className="p-5 sm:p-8 lg:p-12">
            ...
            {step === 4 && (
              <motion.div key="step4" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.15 }} className="p-5 sm:p-8 lg:p-12">
