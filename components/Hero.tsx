...
const SoftwareDetailModal = ({ software, onClose }: { software: SoftwareInfo, onClose: () => void }) => {
  return (
    ...
    >
      <div className="max-w-4xl w-full glass-strong p-8 lg:p-16 relative overflow-y-auto max-h-[90vh] no-scrollbar border-t-4 border-[#CCFF00] rounded-2xl">
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
          <div className="flex-1 space-y-10">
            <div className="space-y-4">
              <span className="text-[10px] font-body tracking-[0.5em] text-[#CCFF00] uppercase font-bold">VIDEO EDITING SOFTWARE</span>
              <div className="flex items-center gap-6">
                <img src={software.src} className="h-12 lg:h-20 w-auto object-contain" alt="" />
                <h3 className="text-3xl lg:text-6xl font-display font-extrabold text-white uppercase tracking-tighter leading-none">{software.name}</h3>
              </div>
            </div>
            <div className="space-y-6">
              <p className="text-xl lg:text-3xl font-display font-bold text-white/90 uppercase leading-tight tracking-tight border-l-4 border-[#CCFF00] pl-6">
                {software.tagline}
              </p>
              <p className="text-sm lg:text-base font-body font-medium text-white/50 uppercase leading-relaxed tracking-wide">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-6 border-t border-white/10">
              {software.techStats.map((stat, i) => (
                <div key={i} className="space-y-1">
                  <span className="text-[9px] font-body text-white/30 uppercase block mb-1 font-bold tracking-widest">{stat.label}</span>
                  <span className="text-sm lg:text-lg font-display font-bold text-white uppercase">{stat.value}</span>
                </div>
              ))}
            </div>
          </div>
          <div className="lg:w-[300px] flex flex-col justify-end gap-6 shrink-0">
            <div className="p-8 glass flex flex-col items-center text-center">
              <Activity className="text-[#CCFF00] mb-4" size={40} />
              <p className="text-[10px] font-body font-bold text-white/40 uppercase tracking-widest leading-relaxed">
            ...
            <a
              ...
              className="w-full py-6 btn-primary text-[10px] tracking-[0.4em] text-center block"
            >
              VIEW FULL SPECS
            </a>
          </div>
  ...
  return (
    ...
    >
      <div className="max-w-6xl w-full relative">
        ...
        <div className="aspect-video w-full bg-black rounded-xl overflow-hidden border border-white/10">
          <iframe
            ...
            <div className="space-y-6 pt-4 border-t border-white/10">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <p className="text-[10px] text-white/40 uppercase leading-tight font-bold">Instantly qualifies leads from platforms like Zillow, checks your calendar, and books tours based on property location and traffic patterns.</p>
                </div>
                <div className="space-y-2">
                  <span className="text-[9px] font-body text-[#CCFF00] uppercase block font-bold tracking-widest">E-COMMERCE</span>
                  <p className="text-[10px] text-white/40 uppercase leading-tight font-bold">Handles 'Where is my order?' queries by actually checking shipping APIs and issuing partial refunds for delays—without you lifting a finger.</p>
                </div>
                <div className="space-y-2">
                  <span className="text-[9px] font-body text-[#CCFF00] uppercase block font-bold tracking-widest">PROFESSIONAL SERVICES</span>
                  <p className="text-[10px] text-white/40 uppercase leading-tight font-bold">Scans legal documents for risk clauses or summarizes 50+ page discovery files into 5 high-impact bullet points for your morning review.</p>
                </div>
                <div className="space-y-2">
                  <span className="text-[9px] font-body text-[#CCFF00] uppercase block font-bold tracking-widest">LOCAL TRADES</span>
                  <p className="text-[10px] text-white/40 uppercase leading-tight font-bold">Reviews photos of a job site sent via SMS, calculates a rough material cost based on market rates, and sends a preliminary quote 24/7.</p>
                </div>
              </div>
              <div className="p-4 glass rounded-xl">
                ...
                <p className="text-[9px] font-body text-white/30 uppercase leading-tight">These agents never sleep, never get bored, and their capacity is limited only by your imagination. They are the ultimate force-multiplier for a lean, high-profit team.</p>
              </div>
            </div>
          </div>
        )
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-6">
                <div className="p-6 glass rounded-xl group transition-all hover:border-[#00F0FF]/30">
                  ...
                  <p className="text-[11px] font-body text-white/40 uppercase leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
              <div className="space-y-6">
                <div className="p-8 glass rounded-xl group transition-all hover:border-[#00F0FF]/30">
                  ...
                  <p className="text-sm font-display font-bold text-white/50 uppercase leading-tight mb-4">"THE LIVE JOB-SITE"</p>
                  <p className="text-[11px] font-body text-white/30 uppercase leading-relaxed">
                ...
                <div className="p-8 glass rounded-xl group transition-all hover:border-[#00F0FF]/30">
                  ...
                  <p className="text-sm font-display font-bold text-white/50 uppercase leading-tight mb-4">"THE CLIENT VAULT"</p>
                  <p className="text-[11px] font-body text-white/30 uppercase leading-relaxed">
              ...
              <div className="space-y-6">
                <div className="p-8 glass rounded-xl group transition-all hover:border-[#00F0FF]/30">
                  ...
                  <p className="text-sm font-display font-bold text-white/50 uppercase leading-tight mb-4">"THE CURATED CURRICULUM"</p>
                  <p className="text-[11px] font-body text-white/30 uppercase leading-relaxed">
                ...
                <div className="p-8 glass rounded-xl group transition-all hover:border-[#00F0FF]/30">
                  ...
                  <p className="text-sm font-display font-bold text-white/50 uppercase leading-tight mb-4">"THE ROI COMMAND CENTER"</p>
                  <p className="text-[11px] font-body text-white/30 uppercase leading-relaxed">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-6">
              <div className="p-6 glass rounded-xl flex items-center gap-4">
                ...
                <div>
                  <span className="text-[9px] font-body text-white/40 uppercase block mb-1">GPU</span>
              ...
              <div className="p-6 glass rounded-xl flex items-center gap-4">
                ...
                <div>
                  <span className="text-[9px] font-body text-white/40 uppercase block mb-1">CPU</span>
              ...
              <div className="p-6 glass rounded-xl flex items-center gap-4">
                ...
                <div>
                  <span className="text-[9px] font-body text-white/40 uppercase block mb-1">RAM</span>
              ...
              <div className="p-6 glass rounded-xl flex items-center gap-4 sm:col-span-2">
                ...
                <div>
                  <span className="text-[9px] font-body text-white/40 uppercase block mb-1">NVME STORAGE</span>
          ...
          <div className="space-y-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6">
              {[
                ...
                <div key={i} className="aspect-video relative group overflow-hidden rounded-xl border border-white/10 bg-black cursor-pointer" onClick={() => onShowImage(img.src)}>
      ...
      },
      {
        ...
        content: (
          <div className="space-y-12">
            ...
            <div className="relative">
              <div className="aspect-[2.4/1] w-full bg-black rounded-xl border border-white/10 overflow-hidden">
              ...
              <div className="mt-4 flex items-center justify-between">
                ...
                <span className="text-[9px] font-body text-white/30 uppercase tracking-widest">2.4:1 ASPECT RATIO</span>
              </div>
            </div>
          ...
          <div className="space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <div key={i} className="aspect-[3/4] relative group overflow-hidden rounded-xl border border-white/10 bg-black cursor-pointer" onClick={() => onShowImage(url)}>
    ...
    <div className="py-12 md:py-20 lg:py-32">
      ...
      <div className="md:hidden px-4">
        ...
        <div className="flex glass-nav p-1 mb-4">
          <button onClick={() => { setActiveCategory('software'); setActiveItem(0); }} className={`flex-1 py-3 text-[10px] font-display font-bold uppercase rounded-lg transition-all ${activeCategory === 'software' ? 'bg-[#CCFF00] text-black' : 'text-white/50'}`}>SOFTWARE</button>
          <button onClick={() => { setActiveCategory('hardware'); setActiveItem(0); }} className={`flex-1 py-3 text-[10px] font-display font-bold uppercase rounded-lg transition-all ${activeCategory === 'hardware' ? 'bg-[#CCFF00] text-black' : 'text-white/50'}`}>HARDWARE</button>
        </div>
        <div className="space-y-2">
          {currentItems.map((item, idx) => (
            <div key={item.id} id={`accordion-${item.id}`} className="glass rounded-xl overflow-hidden scroll-mt-20">
              ...
              >
                ...
                <ChevronRight className={`transition-transform ${activeItem === idx ? 'rotate-90 text-black' : 'text-white/30'}`} size={18} />
              </button>
              {isMobile ? (
                activeItem === idx && <div className="p-4 border-t border-white/10">{item.content}</div>
              ) : (
                <AnimatePresence>
                  {activeItem === idx && (
                    <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: 'auto', opacity: 1 }} exit={{ height: 0, opacity: 0 }} transition={{ duration: 0.3 }} className="overflow-hidden">
                      <div className="p-4 border-t border-white/10">{item.content}</div>
                    </motion.div>
                  )}
                </AnimatePresence>
              )}
      ...
      <div className="hidden md:block">
        <div className="max-w-7xl mx-auto glass-strong p-6 lg:p-8 relative z-10 rounded-2xl glow-cyan">
          <div className="relative z-10 mb-12 flex flex-row items-center justify-between gap-6">
            <div>
              <h2 ref={armoryRef} style={armoryGlowStyle} className="proximity-glow text-4xl lg:text-7xl font-display font-extrabold text-white uppercase tracking-tighter leading-none">THE ARMORY</h2>
              <p className="text-[10px] font-body text-white/40 tracking-[0.5em] uppercase mt-2">HIGH-END PRODUCTION AT A FRACTION OF THE COST</p>
            </div>
            <div className="flex glass-nav p-1">
              <button onClick={() => { setActiveCategory('software'); setActiveItem(0); }} className={`px-8 py-3 text-[10px] font-display font-bold uppercase rounded-lg transition-all ${activeCategory === 'software' ? 'bg-[#CCFF00] text-black' : 'text-white/40 hover:text-white'}`}>SOFTWARE ASSETS</button>
              <button onClick={() => { setActiveCategory('hardware'); setActiveItem(0); }} className={`px-8 py-3 text-[10px] font-display font-bold uppercase rounded-lg transition-all ${activeCategory === 'hardware' ? 'bg-[#CCFF00] text-black' : 'text-white/40 hover:text-white'}`}>HARDWARE POWER</button>
            </div>
          </div>
              ...
              <div className="flex-1 overflow-y-auto no-scrollbar py-4">
                {currentItems.map((item, idx) => (
                  <button
                    ...
                    className={`w-full p-6 lg:p-8 text-left transition-all border-b border-white/5 flex gap-6 items-start group ${activeItem === idx ? 'bg-white/[0.05] border-l-4 border-l-[#CCFF00]' : 'hover:bg-white/[0.02]'}`}
                  >
                    <div className={`mt-1 transition-colors ${activeItem === idx ? 'text-[#CCFF00]' : 'text-white/20'}`}>{item.icon}</div>
                    <div>
                      <h4 className={`text-sm lg:text-lg font-display font-bold uppercase tracking-tight mb-2 ${activeItem === idx ? 'gradient-text' : 'text-white/40'}`}>{item.title}</h4>
                      <p className={`text-[10px] font-body font-medium uppercase tracking-tight leading-tight ${activeItem === idx ? 'text-white/60' : 'text-white/20'}`}>{item.blurb}</p>
                    </div>
                  </button>
                ))}
              </div>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="space-y-12">
              <div className="space-y-6">
                <p className="text-3xl sm:text-5xl lg:text-6xl font-display font-extrabold text-white uppercase leading-none tracking-tight">
                  ...
                  <span className="gradient-text">CINEMA CAPTURES THE SOUL.</span>
                </p>
                <div className="h-1 w-32 bg-gradient-to-r from-[#CCFF00] to-[#00F0FF] mx-auto rounded-full" />
              </div>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 text-left">
                <div className="space-y-8">
                  <p className="text-lg lg:text-2xl font-display font-medium text-white/90 uppercase leading-snug tracking-tight">
                  ...
                  <p className="text-sm font-body font-bold text-white/40 uppercase leading-relaxed">
                ...
                <div className="space-y-8 border-l border-white/10 pl-10">
                  <div className="space-y-6">
                    <div className="flex items-start gap-4">
                      <Film className="text-[#CCFF00] shrink-0" size={20} />
                      <div>
                        <p className="text-xs font-display font-bold text-white uppercase mb-1">HERITAGE BRANDING</p>
                        <p className="text-[11px] text-white/50 uppercase leading-relaxed font-bold">This isn't just an advertisement. It's a legacy piece that grows in value as your company matures.</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-4">
                      <Target className="text-[#CCFF00] shrink-0" size={20} />
                      <div>
                        <p className="text-xs font-display font-bold text-white uppercase mb-1">UNMATCHED AUTHORITY</p>
                        <p className="text-[11px] text-white/50 uppercase leading-relaxed font-bold">The visual texture of Hollywood cinema bypasses the natural skepticism of modern leads.</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div id="hero-video-player" className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 pt-12 scroll-mt-20">
                <div className="lg:col-span-8">
                  ...
                  <motion.div key={activeProject.id} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="mt-8 p-10 lg:p-12 glass rounded-xl text-left">
                    ...
                    <h4 className="text-3xl lg:text-4xl font-display font-extrabold text-white uppercase tracking-tighter mb-4 leading-none">{activeProject.title}</h4>
                    <p className="text-base lg:text-lg font-body font-medium text-white/60 uppercase leading-relaxed tracking-wide">{activeProject.description}</p>
                    <div className="mt-8 flex flex-wrap gap-4">
                      <span className="px-3 py-1 glass text-[9px] font-body text-[#CCFF00] uppercase tracking-widest font-bold rounded-lg">PROJECT FOR: {activeProject.company}</span>
                    </div>
                  </motion.div>
                </div>
                <div className="lg:col-span-4 flex flex-col gap-3">
                  <div className="flex-1 space-y-3 overflow-y-auto no-scrollbar max-h-[400px] lg:max-h-none">
                    {projects.map(p => (
                      ...
                      }} className={`w-full p-4 sm:p-6 text-left rounded-xl border transition-all flex items-center justify-between group ${activeProject.id === p.id ? 'bg-[#CCFF00] text-black border-[#CCFF00]' : 'glass text-white hover:border-white/20'}`}>
                        <div className="min-w-0">
                          <p className={`text-[9px] font-body font-bold uppercase mb-1 ${activeProject.id === p.id ? 'text-black/40' : 'text-white/40'}`}>{p.company}</p>
                          <p className="font-display font-bold uppercase text-xs sm:text-sm truncate">{p.title}</p>
                        </div>
                        <ChevronRight size={16} className={`shrink-0 transition-transform ${activeProject.id === p.id ? 'translate-x-1' : ''}`} />
                      </button>
                    ))}
                  </div>
                  <button onClick={onConsultation} className="w-full py-6 sm:py-8 btn-primary text-xs tracking-[0.2em] mt-4">
                    BOOK A CHAT
                  </button>
                </div>
              </div>
              ...
              <div className="w-full pt-10">
                <div className="glass-strong overflow-hidden rounded-2xl text-left">
                  <div className="bg-white p-10 lg:p-16 flex flex-col md:flex-row justify-between items-start md:items-end gap-10 relative overflow-hidden">
                    <div className="relative z-10 max-w-2xl">
                      <span className="text-[10px] font-body tracking-[0.5em] text-black uppercase font-bold block mb-6 px-3 py-1 bg-black/10 inline-block rounded">NARRATIVE-DRIVEN BRAND STORIES</span>
                      <h4 className="text-5xl lg:text-8xl font-display font-extrabold text-black uppercase tracking-tighter leading-[0.8] mb-6">THE HOLLYWOOD <br /> ADVANTAGE.</h4>
                      <p className="text-base lg:text-xl font-display font-bold text-black/80 uppercase tracking-tight max-w-xl">
                        WE USE THE SAME TOOLS AS NETFLIX MASTERPIECES. WHY? BECAUSE YOUR BUSINESS DESERVES TO LOOK LIKE A GLOBAL LEADER, NOT A STARTUP.
                      </p>
                    </div>
                    <div className="relative z-10 flex flex-col items-end">
                      <div className="px-6 py-6 bg-black text-white font-body font-bold text-[10px] lg:text-xs uppercase tracking-[0.2em] rounded-xl flex flex-col items-center justify-center gap-4">
                        ...
                        <span className="text-[9px] font-body text-white/30 uppercase tracking-widest">CLICK FOR INTEL</span>
                      </div>
                    </div>
                  </div>
                  <div className="p-8 lg:p-16 space-y-16">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 border-b border-white/5 pb-16">
                      <div className="lg:col-span-7">
                        <div className="aspect-video relative overflow-hidden rounded-xl border border-white/10 bg-black mb-8 cursor-pointer group" onClick={() => onShowImage("https://images.red.com/komodo-x/kx-rf-main-features-2x.jpg")}>
                          ...
                          <div className="absolute bottom-8 left-8">
                            <span className="text-[10px] font-body font-bold text-[#CCFF00] uppercase block mb-2">MADE IN CALIFORNIA</span>
                            <p className="text-2xl font-display font-extrabold text-white uppercase tracking-tighter">RED KOMODO-X 6K</p>
                          </div>
                        </div>
                      </div>
                      <div className="lg:col-span-5 flex flex-col justify-center space-y-8">
                        <span className="text-[11px] font-body font-bold text-[#CCFF00] uppercase tracking-[0.4em]">THE PSYCHOLOGY OF TRUST</span>
                        <h4 className="text-4xl font-display font-extrabold text-white uppercase tracking-tighter leading-[0.9]">THE COVER <br /> TELLS THE STORY.</h4>
                        <p className="text-sm font-body font-bold text-white/60 uppercase leading-relaxed">
                    ...
                    <div className="flex flex-col items-center text-center gap-8">
                      <div className="max-w-3xl">
                        <h4 className="text-3xl lg:text-5xl font-display font-extrabold text-white uppercase tracking-tighter leading-none mb-6">
                          NETFLIX QUALITY. <span className="text-white/30">MINUS THE EGO.</span>
                        </h4>
                        <p className="text-xs lg:text-sm font-display font-bold text-white/60 uppercase leading-relaxed mb-10">
                        ...
                        <button onClick={onConsultation} className="btn-primary px-12 py-6 text-[10px] tracking-[0.4em]">
        ...
        {showOperatorDeepDive && (
          <motion.div {...fadeProps} className="fixed inset-0 z-[300] flex items-center justify-center p-4 lg:p-8 bg-black/95 backdrop-blur-3xl">
            <div className="max-w-4xl w-full glass-strong p-8 lg:p-16 border-t-4 border-[#CCFF00] max-h-[90vh] overflow-y-auto no-scrollbar relative rounded-2xl">
              <button onClick={() => setShowOperatorDeepDive(false)} className="absolute top-6 right-6 lg:top-8 lg:right-8 text-white/40 hover:text-white transition-colors"><X size={32} /></button>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
                <div className="space-y-6">
                  <div className="p-6 glass rounded-xl">
                    ...
                    <p className="text-sm font-body font-medium text-white/60 uppercase leading-relaxed tracking-tight">
                ...
                <div className="space-y-6 lg:space-y-8">
                  <span className="text-[10px] font-body text-white/30 uppercase tracking-widest block font-bold">WHAT YOU GET</span>
                  <div className="space-y-4">
                      ...
                      <div key={i} onClick={() => setExpandedHelpIndex(expandedHelpIndex === i ? null : i)} className="cursor-pointer glass rounded-xl overflow-hidden hover:border-white/20 transition-all">
                        <div className="flex gap-4 p-4 items-start">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-[9px] font-body font-bold text-white/40 uppercase tracking-widest">{m.desc}</p>
                          </div>
                          <ChevronRight size={14} className={`text-[#CCFF00] mt-1 transition-transform ${expandedHelpIndex === i ? 'rotate-90' : ''}`} />
                        </div>
                        <AnimatePresence>
                          {expandedHelpIndex === i && (
                            <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: 'auto', opacity: 1 }} exit={{ height: 0, opacity: 0 }} className="px-4 pb-4 border-t border-white/10">
                              <p className="pt-3 text-[10px] font-body font-medium text-white/40 uppercase leading-relaxed tracking-tight">{m.explanation}</p>
                            </motion.div>
                          )}
                        </AnimatePresence>
                      </div>
